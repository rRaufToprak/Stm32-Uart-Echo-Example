...
int main(void)
{
  ...
  MX_USART1_UART_Init();
  /* USER CODE BEGIN 2 */
	sprintf((char*)message, "Communication OK!\n");
	HAL_UART_Transmit_IT(&huart1,message, strlen((char*)message));
	HAL_Delay(1000);
	sprintf((char*)message, "Waiting for message...\n");
	HAL_UART_Transmit_IT(&huart1,message, strlen((char*)message));
